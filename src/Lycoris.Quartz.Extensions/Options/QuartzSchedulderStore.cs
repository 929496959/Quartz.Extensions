...
namespace Lycoris.Quartz.Extensions.Options
{
    internal static class QuartzSchedulderStore
    {
        ...
        /// 
        /// </summary>
        internal static bool AutoRunJob { get; set; } = true;
        ...
        /// 
        /// </summary>
        static readonly List<QuartzJobTypes> JobTypes = new();

        /// <summary>
        /// 
        /// </summary>
        /// <param name="assembly"></param>
        internal static void AddJobAssembly([NotNull] Assembly assembly) => AddJobTypes(assembly.GetTypes());

        /// <summary>
        /// 
        /// </summary>
        /// <param name="types"></param>
        internal static void AddJobTypes([NotNull] params Type[] types)
        {
        ...
        internal static void AddJobTypes([NotNull] Type type)
        {
