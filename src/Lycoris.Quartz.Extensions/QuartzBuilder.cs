...
namespace Lycoris.Quartz.Extensions
{
    ...
    public sealed class QuartzBuilder
    {
        ...
        /// 默认不启用
        /// </summary>
        public bool EnabledLycorisLogger { get; set; } = false;
        ...
        /// <returns></returns>
        public QuartzBuilder AddJob([NotNull] params Type[] types)
        {
        ...
        /// </summary>
        /// <typeparam name="T"></typeparam>
        public void AddLycorisLoggerFactory<T>() where T : ILycorisLoggerFactory
        ...
        /// </summary>
        public void StopAutoRunJob() => QuartzSchedulderStore.AutoRunJob = false;
